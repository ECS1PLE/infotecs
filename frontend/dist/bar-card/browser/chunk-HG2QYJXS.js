...
var ConfirmDialogComponent = class _ConfirmDialogComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _ConfirmDialogComponent, selectors: [["ui-confirm-dialog"]], decls: 10, vars: 4, consts: [["mat-dialog-title", ""], [1, "max-w-md", "text-sm", "leading-6", "text-white/55"], ["align", "end"], ["mat-button", "", "mat-dialog-close", ""], ["mat-flat-button", "", "color", "warn", 3, "mat-dialog-close"]], template: function ConfirmDialogComponent_Template(rf, ctx) {
      if (rf & 1) {
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(ConfirmDialogComponent, { className: "ConfirmDialogComponent", filePath: "src/app/shared/ui/confirm-dialog/confirm-dialog.component.ts", lineNumber: 33 });
})();
...
//# sourceMappingURL=chunk-HG2QYJXS.js.map
