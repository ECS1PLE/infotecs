...
var EmptyStateComponent = class _EmptyStateComponent {
  ...
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _EmptyStateComponent, selectors: [["ui-empty-state"]], inputs: { title: [1, "title"], description: [1, "description"] }, ngContentSelectors: _c0, decls: 7, vars: 2, consts: [[1, "rounded-3xl", "border", "border-dashed", "border-white/15", "bg-white/[0.025]", "px-6", "py-16", "text-center"], [1, "text-2xl", "font-bold", "tracking-tight"], [1, "mx-auto", "mt-3", "max-w-md", "text-sm", "leading-6", "text-white/45"], [1, "mt-7"]], template: function EmptyStateComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275projectionDef();
...
(() => {
  ...
  }], null, { title: [{ type: Input, args: [{ isSignal: true, alias: "title", required: true }] }], description: [{ type: Input, args: [{ isSignal: true, alias: "description", required: true }] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(EmptyStateComponent, { className: "EmptyStateComponent", filePath: "src/app/shared/ui/empty-state/empty-state.component.ts", lineNumber: 18 });
})();
...
// src/app/features/cocktails/components/cocktail-table.component.ts
var _c04 = (a0) => ["/cocktails", a0];
var _c13 = (a0) => ["/cocktails", a0, "edit"];
function CocktailTableComponent_th_4_Template(rf, ctx) {
  if (rf & 1) {
...
function CocktailTableComponent_td_5_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "img", 14);
    \u0275\u0275pipe(1, "mediaUrl");
  }
  if (rf & 2) {
    ...
    \u0275\u0275property("src", \u0275\u0275pipeBind1(1, 2, item_r1.imageUrl), \u0275\u0275sanitizeUrl)("alt", item_r1.name);
  }
}
function CocktailTableComponent_td_5_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
...
function CocktailTableComponent_td_5_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 12)(1, "div", 13);
    \u0275\u0275conditionalCreate(2, CocktailTableComponent_td_5_Conditional_2_Template, 2, 4, "img", 14)(3, CocktailTableComponent_td_5_Conditional_3_Template, 2, 0, "div", 15);
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
...
function CocktailTableComponent_th_7_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 11);
    \u0275\u0275text(1, "\u041A\u043E\u043A\u0442\u0435\u0439\u043B\u044C");
    \u0275\u0275elementEnd();
...
function CocktailTableComponent_td_8_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 12)(1, "a", 16);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    ...
    \u0275\u0275advance();
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(3, _c04, item_r2.id));
    \u0275\u0275advance();
...
function CocktailTableComponent_th_10_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "th", 11);
    \u0275\u0275text(1, "\u0414\u043E\u0431\u0430\u0432\u043B\u0435\u043D");
    \u0275\u0275elementEnd();
...
function CocktailTableComponent_td_11_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "td", 12)(1, "span", 18);
    \u0275\u0275text(2);
    \u0275\u0275pipe(3, "date");
    \u0275\u0275elementEnd()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1(" ", \u0275\u0275pipeBind2(3, 1, item_r3.createdAt, "dd.MM.yyyy, HH:mm"), " ");
  }
}
function CocktailTableComponent_th_13_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "th", 11);
  }
}
function CocktailTableComponent_td_14_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "td", 12)(1, "div", 19)(2, "a", 20);
    \u0275\u0275text(3, "\u041E\u0442\u043A\u0440\u044B\u0442\u044C");
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function CocktailTableComponent_td_14_Template_button_click_6_listener() {
      const item_r5 = \u0275\u0275restoreView(_r4).$implicit;
      const ctx_r5 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r5.remove.emit(item_r5));
    });
    \u0275\u0275text(7, "\u0423\u0434\u0430\u043B\u0438\u0442\u044C");
    \u0275\u0275elementEnd()()();
  }
  if (rf & 2) {
    ...
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(2, _c04, item_r5.id));
    \u0275\u0275advance(2);
    \u0275\u0275property("routerLink", \u0275\u0275pureFunction1(4, _c13, item_r5.id));
  }
}
function CocktailTableComponent_tr_15_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 22);
  }
}
function CocktailTableComponent_tr_16_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "tr", 23);
  }
}
var CocktailTableComponent = class _CocktailTableComponent {
  constructor() {
    ...
    this.remove = output();
    this.columns = ["image", "name", "createdAt", "actions"];
  }
  static {
    this.\u0275fac = function CocktailTableComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _CocktailTableComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CocktailTableComponent, selectors: [["app-cocktail-table"]], inputs: { items: [1, "items"] }, outputs: { remove: "remove" }, decls: 17, vars: 3, consts: [[1, "glass-panel", "overflow-hidden", "rounded-3xl"], [1, "overflow-x-auto"], ["mat-table", "", 1, "w-full", "!min-w-[820px]", 3, "dataSource"], ["matColumnDef", "image"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "name"], ["matColumnDef", "createdAt"], ["matColumnDef", "actions"], ["mat-header-row", "", 4, "matHeaderRowDef"], ["mat-row", "", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", ""], ["mat-cell", ""], [1, "my-3", "h-14", "w-20", "overflow-hidden", "rounded-xl", "border", "border-white/10", "bg-white/[0.03]"], [1, "h-full", "w-full", "object-cover", 3, "src", "alt"], [1, "grid", "h-full", "w-full", "place-items-center", "text-[10px]", "uppercase", "tracking-widest", "text-white/20"], [1, "font-semibold", "transition", "hover:text-[#72f6ff]", 3, "routerLink"], [1, "mt-1", "max-w-md", "truncate", "text-xs", "text-white/35"], [1, "text-sm", "text-white/55"], [1, "flex", "justify-end", "gap-2"], ["mat-button", "", 3, "routerLink"], ["mat-button", "", "type", "button", 3, "click"], ["mat-header-row", ""], ["mat-row", ""]], template: function CocktailTableComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "table", 2);
        \u0275\u0275elementContainerStart(3, 3);
        \u0275\u0275template(4, CocktailTableComponent_th_4_Template, 2, 0, "th", 4)(5, CocktailTableComponent_td_5_Template, 4, 1, "td", 5);
        \u0275\u0275elementContainerEnd();
        \u0275\u0275elementContainerStart(6, 6);
        \u0275\u0275template(7, CocktailTableComponent_th_7_Template, 2, 0, "th", 4)(8, CocktailTableComponent_td_8_Template, 5, 5, "td", 5);
        \u0275\u0275elementContainerEnd();
        \u0275\u0275elementContainerStart(9, 7);
        \u0275\u0275template(10, CocktailTableComponent_th_10_Template, 2, 0, "th", 4)(11, CocktailTableComponent_td_11_Template, 4, 4, "td", 5);
        \u0275\u0275elementContainerEnd();
        \u0275\u0275elementContainerStart(12, 8);
        \u0275\u0275template(13, CocktailTableComponent_th_13_Template, 1, 0, "th", 4)(14, CocktailTableComponent_td_14_Template, 8, 6, "td", 5);
        \u0275\u0275elementContainerEnd();
        \u0275\u0275template(15, CocktailTableComponent_tr_15_Template, 1, 0, "tr", 9)(16, CocktailTableComponent_tr_16_Template, 1, 0, "tr", 10);
        \u0275\u0275elementEnd()()();
      }
      if (rf & 2) {
        \u0275\u0275advance(2);
    ...
    }, dependencies: [MatTableModule, MatTable, MatHeaderCellDef, MatHeaderRowDef, MatColumnDef, MatCellDef, MatRowDef, MatHeaderCell, MatCell, MatHeaderRow, MatRow, MatButtonModule, MatButton, RouterLink, DatePipe, MediaUrlPipe], encapsulation: 2 });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CocktailTableComponent, [{
    type: Component,
    args: [{
  ...
  }], null, { items: [{ type: Input, args: [{ isSignal: true, alias: "items", required: true }] }], remove: [{ type: Output, args: ["remove"] }] });
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CocktailTableComponent, { className: "CocktailTableComponent", filePath: "src/app/features/cocktails/components/cocktail-table.component.ts", lineNumber: 78 });
})();

// src/app/features/cocktails/pages/cocktail-list-page.component.ts
function CocktailListPageComponent_Conditional_3_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "ui-loading-state", 2);
  }
}
function CocktailListPageComponent_Conditional_3_Conditional_2_Conditional_0_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "ui-empty-state", 3)(1, "a", 4);
    \u0275\u0275text(2, "\u0421\u043E\u0437\u0434\u0430\u0442\u044C");
    \u0275\u0275elementEnd()();
  }
}
function CocktailListPageComponent_Conditional_3_Conditional_2_Conditional_1_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 5);
    \u0275\u0275text(1);
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(2, "app-cocktail-table", 6);
    \u0275\u0275listener("remove", function CocktailListPageComponent_Conditional_3_Conditional_2_Conditional_1_Template_app_cocktail_table_remove_2_listener($event) {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext(3);
      return \u0275\u0275resetView(ctx_r1.confirmDelete($event));
    });
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const items_r3 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275textInterpolate2(" ", items_r3.length, " ", items_r3.length === 1 ? "\u0440\u0435\u0446\u0435\u043F\u0442" : "\u0440\u0435\u0446\u0435\u043F\u0442\u043E\u0432", " ");
    \u0275\u0275advance();
    \u0275\u0275property("items", items_r3);
  }
}
function CocktailListPageComponent_Conditional_3_Conditional_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, CocktailListPageComponent_Conditional_3_Conditional_2_Conditional_0_Template, 3, 0, "ui-empty-state", 3)(1, CocktailListPageComponent_Conditional_3_Conditional_2_Conditional_1_Template, 3, 3);
  }
  if (rf & 2) {
    \u0275\u0275conditional(ctx.length === 0 ? 0 : 1);
  }
}
function CocktailListPageComponent_Conditional_3_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275conditionalCreate(0, CocktailListPageComponent_Conditional_3_Conditional_0_Template, 1, 0, "ui-loading-state", 2);
    \u0275\u0275pipe(1, "async");
    \u0275\u0275conditionalBranchCreate(2, CocktailListPageComponent_Conditional_3_Conditional_2_Template, 2, 1);
  }
  if (rf & 2) {
    let tmp_2_0;
    const status_r4 = ctx;
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275conditional(status_r4 === "loading" || status_r4 === "idle" ? 0 : (tmp_2_0 = \u0275\u0275pipeBind1(1, 1, ctx_r1.items$)) ? 2 : -1, tmp_2_0);
  }
}
var CocktailListPageComponent = class _CocktailListPageComponent {
  constructor() {
    this.cocktailsFacade = inject(CocktailsFacade);
    this.dialog = inject(MatDialog);
    this.snackBar = inject(MatSnackBar);
    this.items$ = this.cocktailsFacade.items$;
    this.status$ = this.cocktailsFacade.status$;
  }
  ngOnInit() {
    this.cocktailsFacade.loadList();
  }
  confirmDelete(cocktail) {
    const data = {
      title: `\u0423\u0434\u0430\u043B\u0438\u0442\u044C \xAB${cocktail.name}\xBB?`,
  ...
  static {
    this.\u0275fac = function CocktailListPageComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _CocktailListPageComponent)();
    };
  }
  static {
    this.\u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _CocktailListPageComponent, selectors: [["app-cocktail-list-page"]], decls: 5, vars: 3, consts: [["eyebrow", "\u043A\u0430\u0442\u0430\u043B\u043E\u0433", "title", "\u041A\u043E\u043A\u0442\u0435\u0439\u043B\u0438", "description", "\u0421\u043F\u0438\u0441\u043E\u043A \u0441\u043E\u0445\u0440\u0430\u043D\u0451\u043D\u043D\u044B\u0445 \u0440\u0435\u0446\u0435\u043F\u0442\u043E\u0432."], ["mat-flat-button", "", "routerLink", "/cocktails/new", 1, "!h-11"], ["label", "\u0417\u0430\u0433\u0440\u0443\u0437\u043A\u0430..."], ["title", "\u041F\u043E\u043A\u0430 \u043F\u0443\u0441\u0442\u043E", "description", "\u0414\u043E\u0431\u0430\u0432\u044C\u0442\u0435 \u043F\u0435\u0440\u0432\u044B\u0439 \u0440\u0435\u0446\u0435\u043F\u0442."], ["mat-flat-button", "", "routerLink", "/cocktails/new"], [1, "mb-4", "text-sm", "text-white/35"], [3, "remove", "items"]], template: function CocktailListPageComponent_Template(rf, ctx) {
      if (rf & 1) {
        \u0275\u0275elementStart(0, "ui-page-header", 0)(1, "a", 1);
        \u0275\u0275text(2, " \u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C ");
        \u0275\u0275elementEnd()();
        \u0275\u0275conditionalCreate(3, CocktailListPageComponent_Conditional_3_Template, 3, 3);
        \u0275\u0275pipe(4, "async");
      }
      if (rf & 2) {
        let tmp_0_0;
        \u0275\u0275advance(3);
        \u0275\u0275conditional((tmp_0_0 = \u0275\u0275pipeBind1(4, 1, ctx.status$)) ? 3 : -1, tmp_0_0);
      }
    }, dependencies: [
      RouterLink,
      MatButtonModule,
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CocktailListPageComponent, [{
    type: Component,
    args: [{
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(CocktailListPageComponent, { className: "CocktailListPageComponent", filePath: "src/app/features/cocktails/pages/cocktail-list-page.component.ts", lineNumber: 62 });
})();
export {
  CocktailListPageComponent
};
//# sourceMappingURL=chunk-6KTAHRRT.js.map
